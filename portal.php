...
<header class="masthead">
	<div class="container">
		<div class="masthead-subheading" style="font-weight:700;">Welcome To Tourly</div>
		<div class="masthead-heading text-uppercase">JOURNEY TO EXPLORE WORLD</div>
...
<section class="page-section" id="contact">
	<div class="container">
		<div class="text-center">
			...
			<h3 class="section-subheading text-muted">Feel Free to Contact and Reach Us!</h3>
		</div>
